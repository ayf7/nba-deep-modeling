...
# Low-dimensional season-phase context for v5 calibration.  The rolling
...
class GameRecordV5:
    ...
    # v5: deterministic pregame season-phase features used only by the
...
__all__ = [
    ...
    "GameDatasetV5", "collate_v5", "load_pair_exposure_seconds",
]

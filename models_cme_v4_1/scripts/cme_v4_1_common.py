...
def build_vocab_from_records_v41(
...
class GameDatasetV41(Dataset):
    def __init__(self, records: list[GameRecordV41]) -> None:
...
def collate_v41(batch: list[dict]) -> dict:
...
__all__ = [
    ...
    # v4 additions
    "GameRecordV41", "build_records_v41", "build_vocab_from_records_v41",
    "GameDatasetV41", "collate_v41", "load_pair_exposure_seconds",
]

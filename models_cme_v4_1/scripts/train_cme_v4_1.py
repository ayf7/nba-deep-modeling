#!/usr/bin/env python3
"""Train CME-v4.1 (hybrid Sinkhorn + K-channel + involvement-supervised).
...
from cme_v4_1_model import CmeV41, CmeV41Config, total_loss  # noqa: E402
...
def run_epoch(
    model: CmeV41, loader: DataLoader, *, device: str,
...
def main() -> None:
    ...
    test_loader = DataLoader(GameDatasetV41(test_recs), batch_size=args.batch_size,
                             shuffle=False, collate_fn=collate_v41)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        print(
            ...
            f"va_δ={va['mean_win_residual']:.3f} va_b={va['home_logit_bias']:.3f} "
            f"va_s={va['win_logit_slope']:.3f}{extra} "
    ...
    print(
        ...
        f"s={te_best['win_logit_slope']:.3f}"
    )

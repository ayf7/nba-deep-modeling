...
class GameDatasetV42(Dataset):
    def __init__(self, records: list[GameRecordV42]) -> None:
...
def collate_v42(batch: list[dict]) -> dict:
...
__all__ = [
    ...
    # v4 additions
    "GameRecordV42", "build_records_v42", "build_vocab_from_records_v42",
    "GameDatasetV42", "collate_v42", "load_pair_exposure_seconds",
]

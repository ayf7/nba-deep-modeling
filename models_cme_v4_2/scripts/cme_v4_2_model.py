"""CME-v4.2: hybrid world model (Sinkhorn budget + K-channel play-style).
...
class CmeV42(nn.Module):
    def __init__(self, cfg: CmeV42Config) -> None:
        super().__init__()
        self.cfg = cfg
        d = cfg.d
        ...
        # -- margin -> win logit, with v4.2 affine calibration --
    ...
    def forward(self, batch: dict) -> dict:
        ...
        if season_phase is None:
            # Defensive fallback for ad-hoc synthetic callers; real v4.2

#!/usr/bin/env python3
"""Expanding-window monthly backtest for CME-Availability-v1.1.
...
from cme_availability_v1_1_common import (  # noqa: E402
    ...
    GameDatasetAvailabilityV11,
    K_BOX,
    K_PAIR,
    PAIR_TARGETS,
    PLAYER_FORM_DIM,
    TABULAR_FEATURE_COLUMNS,
    build_records_availability_v1_1,
    build_team_game_player_seconds_index,
    build_team_vocab,
    build_vocab_from_records_availability_v1_1,
    collate_availability_v1_1,
...
from cme_availability_v1_1_model import CmeAvailabilityV11, CmeAvailabilityV11Config  # noqa: E402
from train_cme_availability_v1_1 import (  # noqa: E402
    default_box_weights,
...
def build_optimizer(model: CmeAvailabilityV11, args: argparse.Namespace) -> torch.optim.Optimizer:
...
def predict_records(
    ...
    *,
    ...
    model.eval()
    loader = DataLoader(
        GameDatasetAvailabilityV11(records, availability_stats),
        batch_size=batch_size,
        shuffle=False,
        collate_fn=collate_availability_v1_1,
    )
    rows: list[dict] = []
    record_i = 0
    with torch.no_grad():
...
def main() -> None:
    ...
    for w_i, window_start in enumerate(test_months, start=1):
        ...
        train_recs = build_records_availability_v1_1(train_df, matchup_rows=train_matchup, player_game_stats=train_pl, **common)
        val_recs = build_records_availability_v1_1(val_df, matchup_rows=val_matchup, player_game_stats=val_pl, **common)
        test_recs = build_records_availability_v1_1(test_df, matchup_rows=test_matchup, player_game_stats=test_pl, **common)
        ...
        train_loader = DataLoader(
            GameDatasetAvailabilityV11(train_recs, availability_stats),
            batch_size=args.batch_size,
            shuffle=True,
            collate_fn=collate_availability_v1_1,
        )
        val_loader = DataLoader(
            GameDatasetAvailabilityV11(val_recs, availability_stats),
            batch_size=args.batch_size,
            shuffle=False,
            collate_fn=collate_availability_v1_1,
        )

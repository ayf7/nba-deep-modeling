#!/usr/bin/env python3
"""Train CME-v3 (hybrid Sinkhorn + K-channel + involvement-supervised).
...
from cme_v3_model import CmeV3, CmeV3Config, total_loss  # noqa: E402
...
def run_epoch(
    model: CmeV3, loader: DataLoader, *, device: str,
...
def main() -> None:
    ...
    test_loader = DataLoader(GameDatasetV3(test_recs), batch_size=args.batch_size,
                             shuffle=False, collate_fn=collate_v3)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        print(
            ...
            f"va_mae={va['margin_mae']:.2f} va_αr={va['alpha_off_corr']:.3f}{extra} "

#!/usr/bin/env python3
"""Train CME-Ratings-v4.1 (roster-adjusted ratings final path + optional post-shock calibration).
...
from cme_ratings_v4_1_model import CmeRatingsV41, CmeRatingsV41Config, total_loss  # noqa: E402
...
def run_epoch(
    model: CmeRatingsV41, loader: DataLoader, *, device: str,

#!/usr/bin/env python3
"""Expanding-window monthly backtest for CME-Ratings-v4.1.
...
from cme_ratings_v4_1_common import (  # noqa: E402
...
from cme_ratings_v4_1_model import CmeRatingsV41, CmeRatingsV41Config  # noqa: E402
from train_cme_ratings_v4_1 import (  # noqa: E402
    default_box_weights, default_pair_weights, run_epoch,
)


DEFAULT_OUTPUT_ROOT = REPO_ROOT / "models_cme_ratings_v4_1" / "artifacts"
...
def predict_window(
    model: CmeRatingsV41, records: list, batch_size: int, device: str,
) -> tuple[np.ndarray, ...]:
    model.eval()
...
def _build_optimizer(model: CmeRatingsV41, args) -> torch.optim.Optimizer:
...
def train_one_window(
    ...
    model = CmeRatingsV41(cfg).to(args.device)

#!/usr/bin/env python3
"""Expanding-window monthly backtest for CME-Ratings-v4.
...
from cme_ratings_v4_common import (  # noqa: E402
...
from cme_ratings_v4_model import CmeRatingsV4, CmeRatingsV4Config  # noqa: E402
from train_cme_ratings_v4 import (  # noqa: E402
    default_box_weights, default_pair_weights, run_epoch,
)


DEFAULT_OUTPUT_ROOT = REPO_ROOT / "models_cme_ratings_v4" / "artifacts"
...
def predict_window(
    model: CmeRatingsV4, records: list, batch_size: int, device: str,
) -> tuple[np.ndarray, ...]:
    model.eval()
...
def _build_optimizer(model: CmeRatingsV4, args) -> torch.optim.Optimizer:
    ...
    for name, param in model.named_parameters():
        ...
        if (name in calibration_param_names
                ...
                or name in {"rating_logit_bias", "log_rating_logit_slope", "raw_cme_gap_weight", "raw_roster_shock_signal_weight"}
...
def train_one_window(
    ...
    model = CmeRatingsV4(cfg).to(args.device)
    ...
    (gids, probs, base_probs, affine_probs, temporal_probs, season_logit_adjustments,
     ...
     rating_logits_roster_adjusted, rating_probs_roster_adjusted, roster_shock_signals,

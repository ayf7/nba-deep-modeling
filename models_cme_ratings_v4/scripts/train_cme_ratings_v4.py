#!/usr/bin/env python3
"""Train CME-Ratings-v4 (hybrid Sinkhorn + K-channel + involvement-supervised).
...
from cme_ratings_v4_model import CmeRatingsV4, CmeRatingsV4Config, total_loss  # noqa: E402
...
def run_epoch(
    model: CmeRatingsV4, loader: DataLoader, *, device: str,

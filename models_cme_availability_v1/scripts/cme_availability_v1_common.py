"""CME-Availability-v1 data layer.
...
@dataclass(frozen=True)
class GameRecordAvailabilityV1:
    base: GameRecordV42
...
def build_records_availability_v1(
    games: pd.DataFrame,
    histories: dict[str, list[TeamGameExposure]],
    *,
    vocab: Vocab,
    ...
    out: list[GameRecordAvailabilityV1] = []
    for base in base_records:
        ...
        out.append(GameRecordAvailabilityV1(
            base=base,
...
def fit_availability_feature_stats(
    records: list[GameRecordAvailabilityV1],
...
class GameDatasetAvailabilityV1(Dataset):
    def __init__(
        self,
        records: list[GameRecordAvailabilityV1],
...
def collate_availability_v1(batch: list[dict]) -> dict:
    base_batch = [
...
def build_vocab_from_records_availability_v1(*args, **kwargs):
...
__all__ = [
    ...
    "PlayerStatusDetail", "AvailabilityFeatureStats", "GameRecordAvailabilityV1",
    "build_team_game_player_seconds_index", "load_game_player_status_details",
    "build_availability_raw_features", "build_records_availability_v1",
    "fit_availability_feature_stats", "transform_availability_features",
    "GameDatasetAvailabilityV1", "collate_availability_v1",

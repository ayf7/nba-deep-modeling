#!/usr/bin/env python3
"""Train CME-v4.4 (hybrid Sinkhorn + K-channel + involvement-supervised).
...
from cme_v4_4_common import (  # noqa: E402
    BOX_INDEX, BOX_TARGETS, K_BOX, K_PAIR, K_PROCESS_FEATURES, PAIR_TARGETS,
    ...
    fit_player_form_stats, fit_process_feature_stats, fit_tabular_stats,
    ...
    load_process_pregame_features, load_status_calibration, load_team_exposures,
)
from cme_v4_4_model import CmeV44, CmeV44Config, total_loss  # noqa: E402
...
def run_epoch(
    model: CmeV44, loader: DataLoader, *, device: str,
...
def main() -> None:
    ...
    test_loader = DataLoader(GameDatasetV44(test_recs, include_base_tabular=not args.no_tabular), batch_size=args.batch_size,
                             shuffle=False, collate_fn=collate_v44)

    base_tabular_dim = 0 if args.no_tabular else len(TABULAR_FEATURE_COLUMNS)
    ...
    print(f"[features] base_tabular_dim={base_tabular_dim} process_tabular_dim={process_tabular_dim} total_tabular_dim={tabular_dim}")
    ...
    summary = {
        ...
        "base_tabular_dim": base_tabular_dim,

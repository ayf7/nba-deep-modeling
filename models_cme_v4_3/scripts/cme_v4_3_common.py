...
# Low-dimensional season-phase context for v4.3 calibration.  The rolling
...
class GameRecordV43:
    ...
    # v4.3: deterministic pregame season-phase features used only by the
...
def build_vocab_from_records_v43(
...
class GameDatasetV43(Dataset):
    def __init__(self, records: list[GameRecordV43]) -> None:
...
def collate_v43(batch: list[dict]) -> dict:
...
__all__ = [
    ...
    # v4 additions
    "GameRecordV43", "build_records_v43", "build_vocab_from_records_v43",
    "GameDatasetV43", "collate_v43", "load_pair_exposure_seconds",
]

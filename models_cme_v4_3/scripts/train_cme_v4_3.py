#!/usr/bin/env python3
"""Train CME-v4.3 (hybrid Sinkhorn + K-channel + involvement-supervised).
...
from cme_v4_3_model import CmeV43, CmeV43Config, total_loss  # noqa: E402
...
def run_epoch(
    model: CmeV43, loader: DataLoader, *, device: str,
    ...
    matchup_evidence_reg_w: float = 0.10,
...
def main() -> None:
    ...
    test_loader = DataLoader(GameDatasetV43(test_recs), batch_size=args.batch_size,
                             shuffle=False, collate_fn=collate_v43)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        print(
            ...
            f"η={tr['mean_matchup_evidence_residual']:.3f} "
            ...
            f"va_η={va['mean_matchup_evidence_residual']:.3f} "
    ...
    print(
        ...
        f"η={te_best['mean_matchup_evidence_residual']:.3f} "

"""CME-Ratings-v4.2: roster-adjusted ratings promoted to the final path.
...
Ratings-v4.2 therefore removes CME residuals from the winner-probability path,
...
from cme_ratings_v4_2_common import K_ROSTER_SHOCK_FEATURES  # noqa: E402
...
@dataclass
class CmeRatingsV42Config(CmeRatingsV2Config):
    ...
    # v4.2 promotion: the roster-adjusted ratings anchor is final, with an
...
class CmeRatingsV42(CmeRatingsV2):
    def __init__(self, cfg: CmeRatingsV42Config) -> None:
        super().__init__(cfg)
        self.roster_cfg = cfg
    ...
    def forward(self, batch: dict) -> dict:
        ...
        # v4.2 final path: optional post-shock affine calibration.  If disabled,

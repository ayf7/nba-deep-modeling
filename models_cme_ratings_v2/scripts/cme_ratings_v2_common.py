"""CME-Ratings-v2 data layer: v4.2 + dynamic opponent-adjusted team priors.
...
def build_records_ratings_v2(
    ...
    **kwargs,
) -> list[GameRecordRatingsV2]:
    base_records = build_records_v42(games, *args, **kwargs)
    out: list[GameRecordRatingsV2] = []
...
class GameDatasetRatingsV2(Dataset):
    def __init__(self, records: list[GameRecordRatingsV2]) -> None:
...
def collate_ratings_v2(batch: list[dict]) -> dict:

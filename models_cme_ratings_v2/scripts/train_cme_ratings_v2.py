#!/usr/bin/env python3
"""Train CME-Ratings-v2 (hybrid Sinkhorn + K-channel + involvement-supervised).
...
from cme_ratings_v2_model import CmeRatingsV2, CmeRatingsV2Config, total_loss  # noqa: E402
...
def run_epoch(
    model: CmeRatingsV2, loader: DataLoader, *, device: str,
...
def main() -> None:
    ...
    test_loader = DataLoader(GameDatasetRatingsV2(test_recs), batch_size=args.batch_size,
                             shuffle=False, collate_fn=collate_ratings_v2)

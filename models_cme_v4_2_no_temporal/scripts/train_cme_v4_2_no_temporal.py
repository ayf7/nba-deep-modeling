#!/usr/bin/env python3
"""Train CME-v4.2 (hybrid Sinkhorn + K-channel + involvement-supervised).
...
from cme_v4_2_no_temporal_model import CmeV42NoTemporal, CmeV42NoTemporalConfig, total_loss  # noqa: E402
...
def run_epoch(
    model: CmeV42NoTemporal, loader: DataLoader, *, device: str,
...
def main() -> None:
    ...
    test_loader = DataLoader(GameDatasetV42NoTemporal(test_recs), batch_size=args.batch_size,
                             shuffle=False, collate_fn=collate_v42_no_temporal)
